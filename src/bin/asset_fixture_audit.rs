...
const PLAYER_MESH_SILHOUETTE_MAX_DIVE_FRONT_TO_FALL_FRONT_WIDTH_RATIO: f64 = 0.58;
const PLAYER_MESH_SILHOUETTE_MIN_DIVE_FRONT_HEIGHT_M: f64 = 2.10;
const PLAYER_MESH_SILHOUETTE_MAX_DIVE_FRONT_WIDTH_TO_HEIGHT_RATIO: f64 = 0.67;
const PLAYER_MESH_SILHOUETTE_MAX_DIVE_SIDE_WIDTH_TO_HEIGHT_RATIO: f64 = 0.67;
