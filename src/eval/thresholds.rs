...
pub(super) const MIN_TREE_TRUNK_MESH_VERTICES: usize = 60;
...
pub(super) const MIN_WEATHER_CLOUD_BANK_DEPTH_M: f32 = 4.0;
pub(super) const MIN_WEATHER_CLOUD_LOBE_COUNT: usize = 6;
pub(super) const MIN_MAX_WEATHER_CLOUD_LOBE_COUNT: usize = 10;
pub(super) const MIN_WEATHER_CLOUD_MESH_VERTICES: usize = 900;
pub(super) const MIN_WEATHER_CLOUD_FILAMENT_RIBBON_DETAIL_COUNT: usize = 14;
pub(super) const MIN_ISLAND_TERRAIN_SURFACE_COUNT: usize = 12;
