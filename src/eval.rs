...
pub use scenarios::{
    ...
    ISLAND_LAUNCH_TO_LANDING, LONG_GLIDE_VISIBILITY, PLATEAU_ARRIVAL_CAMERA, POSE_STATE_COVERAGE,
    SCENARIO_NAMES, TERRAIN_BODY_COLLISION_CONTACT, TERRAIN_RIM_COLLISION_CONTACT,
