...
- Sky-island collision follows deterministic terrain relief. The added ravine, terrace, and microrelief substrate stays within existing collision rise/drop bounds, but contact is still a route-surface clamp rather than full rigid-body physics.
