...
- Vertically layered drifting cloud banks with wisp-card edge detail and sinuous filament-ribbon geometry, layered high-cirrus clusters, and wind-responsive near-LOD generated trees with branched trunks, lobed canopies, and organic detail cards provide non-debug weather/environment motion layers without changing gameplay collision or traversal math.
