...
impl EvalSample {
    pub fn to_json(&self) -> String {
        let json = format!(
            ...
            json_number(self.pose_head_gaze_down_alignment),
            ...
            self.mesh_count,
            self.material_count,
            self.loaded_mesh_vertices,
            self.loaded_mesh_triangles,
