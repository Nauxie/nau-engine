...
11. `animation::part_pose` maps flight mode, body-local velocity, input, and route height into visible body/glider poses, including readable dive, air-brake, landing flare/crouch, signed turn lean, and speed-responsive wing flex.
12. Runtime evals sample `animation::pose_readability_metrics` for torso pitch, arm spread, leg tuck, unsigned and signed lateral lean, landing crouch/flare, wing-airflow strength, and key-pose readability; air-control and landing-required scenarios gate those values before counting pose coverage as readable.
...
22. The default world is a 15-island archipelago with 14 route terrain archetypes, varied procedural terrain materials, bounded generated terrain incisions/shelves/microrelief, procedural island bodies, far-LOD layered island impostors, collidable route landmarks/trees/rocks, near/far gameplay updrafts, batched near-LOD ground cover, and a three-gate aerial boost route.
