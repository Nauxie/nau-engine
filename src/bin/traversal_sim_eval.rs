...
const AIR_CONTROL_MIN_LATERAL_RESPONSE_MPS: f32 = 26.0;
...
const AIR_CONTROL_MAX_AVG_BODY_HEADING_ERROR_DEGREES: f32 = 5.0;
const AIR_CONTROL_MAX_P95_BODY_HEADING_ERROR_DEGREES: f32 = 15.0;
const AIR_CONTROL_MAX_BODY_HEADING_ERROR_DEGREES: f32 = 24.0;
const AIR_CONTROL_MAX_BODY_YAW_ERROR_STEP_DEGREES: f32 = 28.0;
const AIR_CONTROL_MAX_BODY_YAW_OSCILLATIONS: f32 = 0.0;
...
const AIR_CONTROL_MAX_P95_LATERAL_BODY_TRAVEL_HEADING_ERROR_DEGREES: f32 = 8.0;
const AIR_CONTROL_MAX_LATERAL_BODY_TRAVEL_HEADING_ERROR_DEGREES: f32 = 18.0;
const AIR_CONTROL_MAX_P95_BACKWARD_DIAGONAL_BODY_TRAVEL_HEADING_ERROR_DEGREES: f32 = 8.0;
const AIR_CONTROL_MAX_BACKWARD_DIAGONAL_BODY_TRAVEL_HEADING_ERROR_DEGREES: f32 = 12.0;
const AIR_CONTROL_MIN_LATERAL_BODY_TRAVEL_HEADING_SAMPLES: u32 = 4;
const AIR_CONTROL_MIN_PURE_AIR_TURN_SIDEWAYS_SAMPLES: u32 = 4;
const AIR_CONTROL_PURE_AIR_TURN_SIDEWAYS_SETTLE_SECS: f32 = 0.10;
const AIR_CONTROL_MIN_BACKWARD_DIAGONAL_BODY_TRAVEL_HEADING_SAMPLES: u32 = 4;
const AIR_CONTROL_MIN_DESIRED_TRAVEL_HEADING_SAMPLES: u32 = 8;
const AIR_CONTROL_MAX_P95_DESIRED_TRAVEL_HEADING_ERROR_DEGREES: f32 = 8.0;
const AIR_CONTROL_MAX_DESIRED_TRAVEL_HEADING_ERROR_DEGREES: f32 = 26.0;
...
const AIR_CONTROL_MIN_AIR_BRAKE_SPEED_DROP_MPS: f32 = 13.0;
const AIR_CONTROL_MIN_AIR_BRAKE_PLANAR_SPEED_DROP_MPS: f32 = 11.5;
const AIR_CONTROL_MIN_POST_BRAKE_ALIGNMENT_MPS: f32 = 14.0;
const AIR_CONTROL_MIN_POSE_AIR_TURN_SAMPLES: u32 = 4;
...
const AIR_CONTROL_MIN_DIVE_POSE_TORSO_PITCH_DEGREES: f32 = 60.0;
const AIR_CONTROL_MAX_DIVE_POSE_ARM_SPREAD_DEGREES: f32 = 100.0;
const AIR_CONTROL_MIN_DIVE_POSE_LEG_TUCK_DEGREES: f32 = 55.0;
...
const MIN_POSE_LIMB_CLEARANCE_M: f32 = 0.04;
const MIN_POSE_SCARF_STREAM_M: f32 = 0.25;
const MIN_POSE_SCARF_LATERAL_SWAY_M: f32 = 0.03;
const MIN_POSE_SCARF_TAIL_FLEX_DEGREES: f32 = 12.0;
