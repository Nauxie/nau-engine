...
pub(super) const AIR_CONTROL_MIN_DIVE_POSE_ARM_SPREAD_DEGREES: f32 = 165.0;
...
pub(super) const MAX_OBSERVED_UPDRAFT_VISUAL_SPEED_MPS: f32 = 80.0;
pub(super) const MAX_OBSERVED_CROSSWIND_VISUAL_SPEED_MPS: f32 = 80.0;
pub(super) const MAX_OBSERVED_WIND_VISUAL_ACCELERATION_MPS2: f32 = 1600.0;
