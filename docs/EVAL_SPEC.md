...
- pose-state coverage scenarios record grounded walk/run, readable launch, readable fall, readable glide, and app-authored `fall` clip samples while rejecting unreadable key-pose samples
...
- `pose_state_coverage`: current walk/run/launch/fall/authored-fall/glide pose-state coverage test.
