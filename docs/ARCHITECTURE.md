...
Landing pose evals now treat landing anticipation and post-contact recovery as distinct readable key poses. Samples include landing feet-forward distance, asymmetric lead/trail foot split, and landing recovery flip angle, and summaries gate recovery-specific flip maxima so generic torso pitch cannot satisfy the landing-recovery check.
