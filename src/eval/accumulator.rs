...
pub struct EvalAccumulator {
    ...
    runtime_frame_times_ms: Vec<f32>,
    eval_artifact_frame_times_ms: Vec<f32>,
    sample_count: u32,
    max_altitude_m: f32,
    min_altitude_m: f32,
    max_grounded_visual_foot_gap_m: f32,
    max_speed_mps: f32,
    max_launch_upward_speed_mps: f32,
    max_launch_horizontal_speed_mps: f32,
    ...
    max_camera_player_relative_step_m: f32,
    max_camera_player_relative_linear_velocity_mps: f32,
    max_camera_player_relative_linear_acceleration_mps2: f32,
    max_camera_player_relative_angular_velocity_degrees_per_sec: f32,
    max_camera_player_relative_angular_acceleration_degrees_per_sec2: f32,
    max_player_integration_residual_m: f32,
    max_player_integration_residual_without_world_collision_m: f32,
    max_player_world_correction_m: f32,
    max_player_collision_correction_m: f32,
    ...
    min_camera_obstructed_distance_m: Option<f32>,
    previous_camera_obstructed_sample: bool,
    camera_obstruction_snap_count: u32,
    camera_follow_correction_frames: u32,
    camera_floor_correction_frames: u32,
    camera_obstruction_correction_frames: u32,
    camera_distance_correction_frames: u32,
    camera_scripted_correction_frames: u32,
    camera_unclassified_correction_frames: u32,
    camera_continuity_offset_limited_frames: u32,
    camera_continuity_rotation_limited_frames: u32,
    last_continuity_frame: Option<u32>,
    ...
    movement_camera_heading_samples: u32,
    max_movement_camera_heading_error_degrees: f32,
    ...
    max_pose_landing_distal_foot_split_m: f32,
    max_pose_landing_flare_degrees: f32,
    max_pose_landing_recovery_flip_degrees: f32,
    max_pose_landing_forward_fold_degrees: f32,
    max_pose_landing_backward_bend_degrees: f32,
    max_pose_landing_transition_backbend_degrees: f32,
    max_pose_landing_torso_offset_m: f32,
    ...
    max_pose_limb_penetration_m: f32,
    max_pose_joint_gap_m: f32,
    pose_joint_gap_samples: u32,
    ...
    authored_glider_launch_samples: u32,
    max_authored_glider_launch_response_degrees: f32,
    max_authored_glider_launch_motion_m: f32,
    ...
    max_player_wind_shear_visual_count: usize,
    max_visible_player_wind_shear_visual_count: usize,
    max_player_wind_shear_length_scale: f32,
    max_player_wind_shear_lateral_offset_m: f32,
    max_player_wind_shear_depth_offset_m: f32,
    max_player_wind_shear_angular_coverage_degrees: f32,
    max_player_wind_shear_vertical_coverage_m: f32,
    max_player_wind_shear_frame_motion_m: f32,
    max_player_wind_shear_orbit_radius_m: f32,
    max_player_wind_shear_pulse_scale: f32,
    max_player_wind_shear_dive_pressure: f32,
    max_player_wind_shear_relative_air_speed_mps: f32,
    max_player_wind_shear_flow_alignment: f32,
    max_player_wind_shear_flow_travel_m: f32,
    max_player_wind_shear_crosswind_deflection_m: f32,
    min_player_wind_shear_body_clearance_m: f32,
    max_player_wind_shear_field_span_m: f32,
    low_speed_player_wind_shear_samples: u32,
    low_speed_visible_player_wind_shear_samples: u32,
    max_visible_player_wind_shear_kind_count: usize,
    ...
    near_island_edge_samples: u32,
    outside_island_footprint_samples: u32,
    outside_near_island_edge_samples: u32,
    ...
    min_generated_ruin_cluster_count: usize,
    ...
    max_material_count: usize,
    max_loaded_mesh_vertices: usize,
    max_loaded_mesh_triangles: usize,
    ...
    gliding_landing_anticipation_samples: u32,
...
impl EvalAccumulator {
    ...
    pub fn observe_continuity(
        ...
        player_world_correction_m: f32,
        player_collision_correction_m: f32,
        world_collision_correction_m: Option<f32>,
    ) {
        camera::observe_continuity(
            self,
            frame,
            camera::ContinuityMetrics {
                camera_distance_m,
                ...
                camera_continuity_offset_limited,
                camera_continuity_rotation_limited,
                player_integration_residual_m,
                player_world_correction_m,
                player_collision_correction_m,
                world_collision_correction_m,
            },
        );
    }
}
