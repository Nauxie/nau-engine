...
- `camera_stress`: fly close to geometry and record camera distance, pitch, obstruction metrics, player-framing distance, and fixed checkpoint screenshots near collidable trees/props.
...
- Camera obstruction checks currently prove avoidance and bounded step size; they do not yet prove that a nearby collidable tree/prop preserves useful player framing. The next camera pass should gate minimum readable framing or an explicit blocker policy with checkpoint screenshots.
