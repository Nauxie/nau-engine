...
addMesh("Nau Suit Upper Arm Seam Band", boxMesh(0.156, 0.052, 0.028), 7);
addMesh("Nau Suit Upper Arm Inner Tendon", boxMesh(0.036, 0.250, 0.024), 0);
...
addMesh("Nau Suit Thigh Quad Panel", ellipsoidMesh([0.058, 0.210, 0.046], 28, 10), 0);
addMesh("Nau Suit Thigh Hamstring Ridge", ellipsoidMesh([0.052, 0.205, 0.046], 24, 9), 0);
...
addMesh("Nau Suit Shoulder Motion Cowl", ellipsoidMesh([0.168, 0.074, 0.126], 42, 14), 0);
addMesh("Nau Suit Elbow Motion Cowl", ellipsoidMesh([0.096, 0.052, 0.074], 38, 12), 0);
addMesh("Nau Suit Hip Motion Cowl", ellipsoidMesh([0.136, 0.066, 0.112], 42, 14), 0);
addMesh("Nau Suit Knee Motion Cowl", ellipsoidMesh([0.092, 0.046, 0.076], 38, 12), 0);
...
for (const side of [
  ...
  addMeshChild(nodeIds.torso, `Nau ${label} Suit Axilla Blend`, meshIndex("Nau Suit Axilla Blend"), {
    translation: [sign * 0.392, 0.436, -0.012],
    rotation: rotZ(sign * 0.30),
    scale: [1.10, 1.00, 1.08],
  });
  addMeshChild(nodeIds.torso, `Nau ${label} Suit Shoulder Web Capsule`, meshIndex("Nau Suit Shoulder Web Capsule"), {
    translation: [sign * 0.420, 0.480, -0.014],
    rotation: rotZ(sign * 0.24),
    scale: [1.12, 1.06, 1.12],
  });
  addMeshChild(nodeIds.torso, `Nau ${label} Suit Shoulder Torso Motion Cowl`, meshIndex("Nau Suit Shoulder Motion Cowl"), {
    translation: [sign * 0.446, 0.524, -0.006],
  ...
  const socket = addChild(nodeIds.torso, `Nau ${label} Shoulder Socket`, {
    translation: [sign * shoulderX, 0.558, -0.02],
  });
  ...
  addMeshChild(arm, `Nau ${label} Suit Upper Arm Seam Band`, meshIndex("Nau Suit Upper Arm Seam Band"), {
    translation: [0.0, -0.214, -0.092],
    rotation: rotZ(sign * 0.03),
  });
  addMeshChild(arm, `Nau ${label} Suit Upper Arm Inner Tendon`, meshIndex("Nau Suit Upper Arm Inner Tendon"), {
    translation: [sign * -0.082, -0.305, -0.020],
    rotation: rotZ(sign * 0.08),
  });
  addMeshChild(arm, `Nau ${label} Shoulder Accent`, meshIndex("Nau Accent Shoulder Guard"), {
    translation: [sign * 0.082, -0.035, -0.014],
    rotation: rotZ(sign * 0.20),
  });
  addMeshChild(arm, `Nau ${label} Suit Deltoid Filler`, meshIndex("Nau Suit Deltoid Filler"), {
    translation: [sign * 0.062, -0.048, 0.0],
    rotation: rotZ(sign * 0.16),
    scale: [0.92, 0.94, 0.94],
  });
  const elbowSocket = addChild(arm, `Nau ${label} Elbow Socket`, {
    translation: [0.0, -0.54, 0.018],
  });
  addMeshChild(elbowSocket, `Nau ${label} Elbow Joint Cover`, meshIndex("Nau Joint Elbow Sleeve"), {
    translation: [0.0, 0.0, 0.0],
    scale: [0.70, 0.052, 0.70],
  });
  addMeshChild(arm, `Nau ${label} Suit Elbow Upper Motion Cowl`, meshIndex("Nau Suit Elbow Motion Cowl"), {
    translation: [0.0, -0.500, 0.018],
    scale: [0.92, 0.78, 0.94],
  });
  ...
  addMeshChild(forearm, `Nau ${label} Leather Forearm Radius Ridge`, meshIndex("Nau Leather Forearm Radius Ridge"), {
    translation: [sign * 0.070, -0.238, -0.030],
    rotation: rotZ(sign * -0.06),
  });
  addMeshChild(forearm, `Nau ${label} Leather Forearm Ulna Ridge`, meshIndex("Nau Leather Forearm Ulna Ridge"), {
    translation: [sign * -0.060, -0.252, 0.060],
    rotation: rotZ(sign * 0.05),
  });
...
for (const side of [
  ...
  addMeshChild(nodeIds.hips, `Nau ${label} Suit Hip Inguinal Blend`, meshIndex("Nau Suit Hip Inguinal Blend"), {
    translation: [sign * 0.232, -0.205, -0.052],
    rotation: rotZ(sign * 0.12),
    scale: [1.08, 1.00, 1.08],
  });
  addMeshChild(nodeIds.hips, `Nau ${label} Suit Hip Web Capsule`, meshIndex("Nau Suit Hip Web Capsule"), {
    translation: [sign * 0.272, -0.174, -0.006],
    rotation: rotZ(sign * 0.10),
    scale: [1.12, 1.04, 1.10],
  });
  addMeshChild(nodeIds.hips, `Nau ${label} Suit Hip Pelvis Motion Cowl`, meshIndex("Nau Suit Hip Motion Cowl"), {
    translation: [sign * 0.282, -0.184, 0.010],
    rotation: rotZ(sign * 0.10),
  ...
  addMeshChild(leg, `Nau ${label} Suit Hip Root Blend`, meshIndex("Nau Suit Hip Root Blend"), {
    translation: [sign * -0.010, -0.042, -0.002],
    rotation: rotZ(sign * 0.08),
    scale: [1.10, 1.04, 1.10],
  });
  ...
  addMeshChild(leg, `Nau ${label} Suit Thigh Quad Panel`, meshIndex("Nau Suit Thigh Quad Panel"), {
    translation: [sign * -0.026, -0.250, -0.080],
    rotation: rotZ(sign * 0.04),
  });
  addMeshChild(leg, `Nau ${label} Suit Thigh Hamstring Ridge`, meshIndex("Nau Suit Thigh Hamstring Ridge"), {
    translation: [sign * 0.044, -0.285, 0.082],
    rotation: rotZ(sign * -0.06),
  });
  ...
  addMeshChild(leg, `Nau ${label} Suit Knee Thigh Motion Cowl`, meshIndex("Nau Suit Knee Motion Cowl"), {
    translation: [0.0, -0.400, 0.010],
    scale: [0.94, 0.82, 0.96],
  });
  ...
  addMeshChild(lowerLeg, `Nau ${label} Suit Lower Leg Outer Calf Ridge`, meshIndex("Nau Suit Lower Leg Outer Calf Ridge"), {
    translation: [sign * 0.072, -0.236, 0.058],
    rotation: rotZ(sign * -0.07),
  });
  addMeshChild(lowerLeg, `Nau ${label} Suit Lower Leg Inner Tendon`, meshIndex("Nau Suit Lower Leg Inner Tendon"), {
    translation: [sign * -0.064, -0.262, -0.040],
    rotation: rotZ(sign * 0.06),
  });
...
const animations = [
  ...
  animation("Fall_Loop", [
    { node: s.hips, path: "rotation", times: loopTimes, values: [rotX(-1.30), rotX(-1.38), rotX(-1.30)] },
    { node: s.torso, path: "rotation", times: loopTimes, values: [rotX(-0.08), rotX(-0.12), rotX(-0.08)] },
    { node: s.head, path: "rotation", times: loopTimes, values: [rotX(0.16), rotX(0.22), rotX(0.16)] },
    { node: s.leftArm, path: "rotation", times: loopTimes, values: [rotZ(1.48), rotZ(1.54), rotZ(1.48)] },
    { node: s.rightArm, path: "rotation", times: loopTimes, values: [rotZ(-1.48), rotZ(-1.54), rotZ(-1.48)] },
    { node: s.leftLeg, path: "rotation", times: loopTimes, values: [rotX(0.42), rotX(0.50), rotX(0.42)] },
    { node: s.rightLeg, path: "rotation", times: loopTimes, values: [rotX(0.42), rotX(0.50), rotX(0.42)] },
  ]),
  ...
  animation("Dive_Loop", [
    ...
    { node: s.leftArm, path: "rotation", times: loopTimes, values: [rotZ(0.08), rotZ(0.10), rotZ(0.08)] },
    { node: s.rightArm, path: "rotation", times: loopTimes, values: [rotZ(-0.08), rotZ(-0.10), rotZ(-0.08)] },
    { node: s.leftLeg, path: "rotation", times: loopTimes, values: [rotX(0.035), rotX(0.065), rotX(0.035)] },
    { node: s.rightLeg, path: "rotation", times: loopTimes, values: [rotX(0.035), rotX(0.065), rotX(0.035)] },
