...
pub(super) const MIN_CROSSWIND_GUIDE_VISUAL_COUNT: usize = 120;
pub(super) const MIN_CROSSWIND_RIBBON_VISUAL_COUNT: usize = 14;
pub(super) const MIN_UPDRAFT_VISUAL_MOTION_M: f32 = 0.45;
pub(super) const MIN_UPDRAFT_VISUAL_RISE_M: f32 = 0.45;
pub(super) const MIN_UPDRAFT_VISUAL_SWIRL_DISPLACEMENT_M: f32 = 0.35;
pub(super) const MIN_UPDRAFT_VISUAL_DEPTH_SPAN_M: f32 = 48.0;
pub(super) const MIN_UPDRAFT_VISUAL_SCALE_PULSE: f32 = 0.06;
pub(super) const MIN_CROSSWIND_VISUAL_MOTION_M: f32 = 0.65;
pub(super) const MIN_CROSSWIND_GUIDE_FLOW_DISPLACEMENT_M: f32 = 0.65;
pub(super) const MIN_CROSSWIND_RIBBON_FLOW_DISPLACEMENT_M: f32 = 0.65;
pub(super) const MIN_CROSSWIND_VISUAL_LANE_DEPTH_SPAN_M: f32 = 30.0;
pub(super) const MIN_CROSSWIND_VISUAL_SCALE_PULSE: f32 = 0.1;
pub(super) const MIN_UPDRAFT_FLOW_COHERENT_VISUAL_COUNT: usize = 108;
pub(super) const MIN_CROSSWIND_FLOW_COHERENT_VISUAL_COUNT: usize = 100;
pub(super) const MIN_WIND_VISUAL_FLOW_ALIGNMENT: f32 = 0.55;
pub(super) const MIN_SUSTAINED_WIND_VISUAL_FLOW_SAMPLES: u32 = 8;
pub(super) const MIN_SUSTAINED_UPDRAFT_VISUAL_FLOW_SAMPLES: u32 = 8;
pub(super) const MIN_SUSTAINED_CROSSWIND_VISUAL_FLOW_SAMPLES: u32 = 8;
