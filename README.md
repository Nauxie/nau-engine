...
3. Deepen projection-backed world-semantic screenshot checks beyond route markers into terrain, vegetation, cloud, and distant-impostor quality signals.
4. Expand world-semantic screenshot checks and async asset-loading simulation once real imported scenes outnumber the current fixture manifest.
