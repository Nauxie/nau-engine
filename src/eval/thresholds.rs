...
pub const MIN_PLAYER_WIND_SHEAR_VISUAL_COUNT: usize = 5;
pub const MIN_VISIBLE_PLAYER_WIND_SHEAR_VISUAL_COUNT: usize = 5;
pub const MIN_PLAYER_WIND_SHEAR_LENGTH_SCALE: f32 = 1.05;
pub const MIN_PLAYER_WIND_SHEAR_LATERAL_OFFSET_M: f32 = 0.09;
pub const MIN_PLAYER_WIND_SHEAR_DEPTH_OFFSET_M: f32 = 0.34;
