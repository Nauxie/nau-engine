...
- `asset_pipeline` owns the declared glTF visual asset inventory and cheap readiness metrics while the active scene still uses generated primitives.
...
- Keep the declared glTF asset inventory wired into runtime/eval diagnostics before real imported scenes are available.
