...
pub(crate) use detail_meshes::{
    ...
    CLOUD_FILAMENT_RIBBONS_PER_LOBE, CLOUD_STRATA_CARDS_PER_LOBE, DETAIL_CARD_VERTICES,
    GARDEN_RING_BANDS, GARDEN_RING_SEGMENTS, HANGING_ROOT_SEGMENTS, HANGING_ROOT_STRANDS,
    IslandArtifactVisualKind, LAKE_BASIN_RIM_BANDS, LAKE_BASIN_RIM_SEGMENTS, LAKE_SURFACE_SEGMENTS,
    ...
    WATERFALL_RIBBON_ROWS, cloud_strata_card_detail_count,
};
pub(crate) use detail_meshes::{
