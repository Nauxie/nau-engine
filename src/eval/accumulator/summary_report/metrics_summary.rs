...
pub(super) fn build_metrics_summary(
    ...
    EvalMetricsSummary {
        ...
        frames_over_16_67ms: derived.frame_time_stats.frames_over_16_ms,
        frames_over_33_34ms: derived.frame_time_stats.frames_over_33_ms,
        frames_over_50ms: derived.frame_time_stats.frames_over_50_ms,
        frames_over_100ms: derived.frame_time_stats.frames_over_100_ms,
        ...
        runtime_frames_over_16_67ms: derived.runtime_frame_time_stats.frames_over_16_ms,
        runtime_frames_over_33_34ms: derived.runtime_frame_time_stats.frames_over_33_ms,
        runtime_frames_over_50ms: derived.runtime_frame_time_stats.frames_over_50_ms,
        runtime_frames_over_100ms: derived.runtime_frame_time_stats.frames_over_100_ms,
        ...
        max_pose_landing_distal_foot_split_m: acc.max_pose_landing_distal_foot_split_m,
        ...
        max_pose_landing_forward_fold_degrees: acc.max_pose_landing_forward_fold_degrees,
        max_pose_landing_backward_bend_degrees: acc.max_pose_landing_backward_bend_degrees,
        max_pose_landing_transition_backbend_degrees: acc
            .max_pose_landing_transition_backbend_degrees,
        max_pose_landing_torso_offset_m: acc.max_pose_landing_torso_offset_m,
        max_pose_wing_airflow_strength: acc.max_pose_wing_airflow_strength,
        max_pose_scarf_stream_m: acc.max_pose_scarf_stream_m,
        max_pose_scarf_lateral_sway_m: acc.max_pose_scarf_lateral_sway_m,
        max_pose_scarf_tail_flex_degrees: acc.max_pose_scarf_tail_flex_degrees,
        ...
        gliding_dive_samples: acc.gliding_dive_samples,
        max_authored_glider_dive_response_degrees: acc.max_authored_glider_dive_response_degrees,
        max_authored_glider_dive_motion_m: acc.max_authored_glider_dive_motion_m,
        ...
        max_pose_limb_penetration_m: acc.max_pose_limb_penetration_m,
        max_pose_joint_gap_m: acc.max_pose_joint_gap_m,
        pose_joint_gap_samples: acc.pose_joint_gap_samples,
        ...
        authored_grounded_idle_clip_samples: acc.authored_grounded_idle_clip_samples,
        authored_grounded_walk_clip_samples: acc.authored_grounded_walk_clip_samples,
        authored_grounded_run_clip_samples: acc.authored_grounded_run_clip_samples,
        authored_launch_clip_samples: acc.authored_launch_clip_samples,
        authored_glide_clip_samples: acc.authored_glide_clip_samples,
        ...
        authored_transition_active_samples: acc.authored_transition_active_samples,
        max_authored_transition_elapsed_ms: acc.max_authored_transition_elapsed_ms,
        max_authored_transition_duration_ms: acc.max_authored_transition_duration_ms,
        max_authored_transition_progress: acc.max_authored_transition_progress,
        ...
        aligned_wind_force_samples: acc.aligned_wind_force_samples,
        crosswind_force_samples: acc.crosswind_force_samples,
        aligned_crosswind_force_samples: acc.aligned_crosswind_force_samples,
        updraft_swirl_force_samples: acc.updraft_swirl_force_samples,
        aligned_updraft_swirl_force_samples: acc.aligned_updraft_swirl_force_samples,
        layered_wind_force_samples: acc.layered_wind_force_samples,
        aligned_layered_wind_force_samples: acc.aligned_layered_wind_force_samples,
        crosswind_updraft_overlap_samples: acc.crosswind_updraft_overlap_samples,
        aligned_crosswind_updraft_overlap_samples: acc.aligned_crosswind_updraft_overlap_samples,
        ...
        max_layered_wind_force_fields: acc.max_layered_wind_force_fields,
        ...
        max_layered_wind_force_delta_mps: acc.max_layered_wind_force_delta_mps,
        max_wind_force_flow_speed_mps: acc.max_wind_force_flow_speed_mps,
        max_wind_force_variation: acc.max_wind_force_variation,
        max_wind_force_flow_alignment: acc.max_wind_force_flow_alignment,
        max_crosswind_force_flow_alignment: acc.max_crosswind_force_flow_alignment,
        max_updraft_swirl_force_flow_alignment: acc.max_updraft_swirl_force_flow_alignment,
        max_layered_wind_force_flow_alignment: acc.max_layered_wind_force_flow_alignment,
        max_wind_force_aligned_delta_mps: acc.max_wind_force_aligned_delta_mps,
        max_crosswind_force_aligned_delta_mps: acc.max_crosswind_force_aligned_delta_mps,
        max_updraft_swirl_force_aligned_delta_mps: acc.max_updraft_swirl_force_aligned_delta_mps,
        max_layered_wind_force_aligned_delta_mps: acc.max_layered_wind_force_aligned_delta_mps,
        wind_load_response_samples: acc.wind_load_response_samples,
        ...
        max_player_wind_shear_visual_count: acc.max_player_wind_shear_visual_count,
        max_visible_player_wind_shear_visual_count: acc.max_visible_player_wind_shear_visual_count,
        ...
        max_updraft_visual_depth_span_m: acc.max_updraft_visual_depth_span_m,
        max_updraft_visual_scale_pulse: acc.max_updraft_visual_scale_pulse,
        ...
        max_crosswind_visual_lane_depth_span_m: acc.max_crosswind_visual_lane_depth_span_m,
        ...
        max_updraft_fields_with_guides_and_ribbons_count: acc
            .max_updraft_fields_with_guides_and_ribbons_count,
        max_updraft_flow_coherent_field_count: acc.max_updraft_flow_coherent_field_count,
        max_crosswind_field_count: acc.max_crosswind_field_count,
        max_crosswind_fields_with_guides_count: acc.max_crosswind_fields_with_guides_count,
        max_crosswind_fields_with_ribbons_count: acc.max_crosswind_fields_with_ribbons_count,
        max_crosswind_fields_with_guides_and_ribbons_count: acc
            .max_crosswind_fields_with_guides_and_ribbons_count,
        max_crosswind_flow_coherent_field_count: acc.max_crosswind_flow_coherent_field_count,
        ...
        max_terrain_body_collision_proxy_count: acc.max_terrain_body_collision_proxy_count,
        max_solid_world_collision_proxy_count: acc.max_solid_world_collision_proxy_count,
        max_tree_world_collision_proxy_count: acc.max_tree_world_collision_proxy_count,
        max_rock_world_collision_proxy_count: acc.max_rock_world_collision_proxy_count,
        max_landmark_world_collision_proxy_count: acc.max_landmark_world_collision_proxy_count,
        ...
        terrain_body_collision_resolved_samples: acc.terrain_body_collision_resolved_samples,
        terrain_body_collision_contact_samples: acc.terrain_body_collision_contact_samples,
        ...
        max_mesh_count: acc.max_mesh_count,
        max_material_count: acc.max_material_count,
        max_loaded_mesh_vertices: acc.max_loaded_mesh_vertices,
        max_loaded_mesh_triangles: acc.max_loaded_mesh_triangles,
        ...
        pose_grounded_idle_samples: acc.pose_grounded_idle_samples,
        ...
        right_pose_air_brake_samples: acc.right_pose_air_brake_samples,
        left_pose_air_brake_samples: acc.left_pose_air_brake_samples,
        backward_right_pose_air_brake_samples: acc.backward_right_pose_air_brake_samples,
        backward_left_pose_air_brake_samples: acc.backward_left_pose_air_brake_samples,
        pose_landing_anticipation_samples: acc.pose_landing_anticipation_samples,
        gliding_landing_anticipation_samples: acc.gliding_landing_anticipation_samples,
