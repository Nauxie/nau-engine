...
13. Island terrain is resident inside the active stream window, inactive or non-near chunks show cheap distant impostors, route beacons remain resident for readability, and nonessential island detail is despawned outside the near LOD band.
...
16. The render stack uses Bevy-native atmosphere, dynamic sun/fog/exposure weather, volumetric fog/light, bloom, filmic tonemapping, procedural PBR texture maps, reflective/transmissive water, emissive markers, drifting cloud banks, and high cirrus veils.
17. The default world is a 12-island archipelago with varied procedural terrain materials, route cairns, near/far gameplay updrafts, and a three-gate aerial boost route.
