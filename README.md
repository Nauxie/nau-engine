...
3. Add exact route-marker semantic signals and projection-backed world-semantic screenshot checks on top of the current image-family and structural export audits.
