...
pub(crate) fn collect_eval_metrics(
    ...
    .with_player_wind_shear_visual_metrics(
        ...
        player_wind_shear_metrics.max_angular_coverage_degrees,
        player_wind_shear_metrics.max_vertical_coverage_m,
        player_wind_shear_metrics.max_frame_motion_m,
        player_wind_shear_metrics.max_orbit_radius_m,
        player_wind_shear_metrics.max_pulse_scale,
        player_wind_shear_metrics.max_dive_pressure,
        player_wind_shear_metrics.max_relative_air_speed_mps,
        player_wind_shear_metrics.max_flow_alignment,
        player_wind_shear_metrics.max_flow_travel_m,
        player_wind_shear_metrics.max_crosswind_deflection_m,
        player_wind_shear_metrics.min_body_clearance_m,
        player_wind_shear_metrics.max_field_span_m,
        player_wind_shear_metrics.visible_kind_count,
    )
