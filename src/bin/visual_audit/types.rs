...
pub(super) struct ImageAudit {
    ...
    pub(super) distant_scene_horizontal_span_fraction: f64,
    pub(super) distant_scene_vertical_span_fraction: f64,
    pub(super) scene_material_family_count: usize,
    pub(super) terrain_scene_fraction: f64,
    pub(super) terrain_scene_tile_count: usize,
    pub(super) terrain_scene_color_bucket_count: usize,
    pub(super) terrain_quality_qualified: bool,
    pub(super) terrain_luma_span: f64,
    pub(super) terrain_internal_edge_density: f64,
    pub(super) terrain_isolated_speck_fraction: f64,
    pub(super) foliage_scene_fraction: f64,
    pub(super) foliage_scene_tile_count: usize,
    pub(super) cloud_layer_fraction: f64,
    pub(super) cloud_layer_component_count: usize,
    pub(super) cloud_layer_horizontal_span_fraction: f64,
    pub(super) cloud_layer_vertical_span_fraction: f64,
