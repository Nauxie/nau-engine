...
pub(super) const MIN_GROUND_COVER_MESH_VERTICES: usize = 1200;
pub(super) const MIN_GENERATED_TREE_TRUNK_COUNT: usize = 55;
pub(super) const MIN_GENERATED_TREE_CANOPY_COUNT: usize = 55;
...
pub(super) const MIN_GENERATED_POND_SURFACE_COUNT: usize = SKY_ROUTE_ISLAND_COUNT;
