...
pub use obstruction::{
    ...
    CAMERA_OBSTRUCTION_SNAP_DISTANCE_DELTA_M, CameraObstructionSmoothingState,
    avoid_camera_obstructions, avoid_camera_obstructions_with_preferred_offset,
    camera_frame_step_budget, camera_obstruction_is_active, camera_rotation_step_budget,
    clamp_camera_offset_step, clamp_camera_rotation_step, clamp_camera_step,
    lift_camera_above_floor, revalidate_camera_obstruction, smooth_camera_obstruction,
};
pub use types::{
