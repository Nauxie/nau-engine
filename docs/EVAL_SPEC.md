...
- landing-required routes exercised readable airborne-only landing-anticipation pose coverage before contact, rejected landing anticipation while still gliding, readable landing-recovery pose coverage after contact, reached at least 0.05 m of landing crouch, reached at least 0.32 m of feet-forward landing tuck, reached signed forward-fold absorption while keeping positive backward bend under threshold, kept landing local torso bend and torso offset under their thresholds including transition-grace frames, produced zero key-pose samples below the 0.9 readability floor after bounded transition grace, recorded landing-only visible-pose temporal samples, and kept landing pose-part rotation/translation deltas within landing-specific route thresholds
