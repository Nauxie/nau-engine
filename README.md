...
3. Add richer screenshot-level terrain-material identity, vegetation/cloud readability, and exact route-marker semantic signals on top of the current structural export audits.
