...
- `Shift` dives.
- Player posing now derives a shared pose intent for grounded idle/stride, launch, fall, glide, dive, air brake, and landing anticipation so generated fallback poses, authored clip selection, and eval labels stay aligned.
