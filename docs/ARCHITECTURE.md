...
- `src/eval.rs` owns eval sample structures, metric accumulation, JSON summaries, and gate assembly for movement, camera, content, streaming, assets, and screenshots.
