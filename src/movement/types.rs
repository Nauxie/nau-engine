...
impl Default for FlightTuning {
    fn default() -> Self {
        Self {
            ...
            air_velocity_turn_rate_degrees: 150.0,
            glide_velocity_turn_rate_degrees: 170.0,
            air_velocity_counter_turn_rate_degrees: 240.0,
            glide_velocity_counter_turn_rate_degrees: 300.0,
