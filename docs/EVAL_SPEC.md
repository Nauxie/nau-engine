...
- The current pose eval surface proves named state coverage and readable key-pose floors, but the next character-quality pass should add limb spacing, self-intersection-risk, full-body fall orientation, head-down dive orientation, and temporal pose-smoothness metrics before increasing model complexity.
