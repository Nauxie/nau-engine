...
pub struct EvalMetricsSummary {
    ...
    pub frames_over_16_67ms: u32,
    pub frames_over_33_34ms: u32,
    pub frames_over_50ms: u32,
    pub frames_over_100ms: u32,
    ...
    pub runtime_frames_over_16_67ms: u32,
    pub runtime_frames_over_33_34ms: u32,
    pub runtime_frames_over_50ms: u32,
    pub runtime_frames_over_100ms: u32,
    ...
    pub max_dive_pose_head_gaze_down_alignment: f32,
    ...
    pub max_player_wind_shear_angular_coverage_degrees: f32,
    pub max_player_wind_shear_vertical_coverage_m: f32,
    pub max_player_wind_shear_frame_motion_m: f32,
    pub max_player_wind_shear_orbit_radius_m: f32,
    pub max_player_wind_shear_pulse_scale: f32,
    pub max_player_wind_shear_dive_pressure: f32,
    pub max_player_wind_shear_relative_air_speed_mps: f32,
    pub max_player_wind_shear_flow_alignment: f32,
    pub max_player_wind_shear_flow_travel_m: f32,
    pub max_player_wind_shear_crosswind_deflection_m: f32,
    pub min_player_wind_shear_body_clearance_m: f32,
    pub max_player_wind_shear_field_span_m: f32,
    pub low_speed_player_wind_shear_samples: u32,
    pub low_speed_visible_player_wind_shear_samples: u32,
    pub max_visible_player_wind_shear_kind_count: usize,
    ...
    pub max_loaded_mesh_vertices: usize,
    pub max_loaded_mesh_triangles: usize,
...
impl EvalMetricsSummary {
    fn to_json(&self, indent: &str) -> String {
        let json = format!(
            ...
            self.frames_over_16_67ms,
            self.frames_over_33_34ms,
            self.frames_over_50ms,
            self.frames_over_100ms,
            ...
            self.runtime_frames_over_16_67ms,
            self.runtime_frames_over_33_34ms,
            self.runtime_frames_over_50ms,
            self.runtime_frames_over_100ms,
            ...
            self.max_loaded_mesh_vertices,
            self.max_loaded_mesh_triangles,
        ...
        let wind_force_metrics = format!(
            ...
            self.low_speed_player_wind_shear_samples,
            self.low_speed_visible_player_wind_shear_samples,
            self.max_visible_player_wind_shear_kind_count,
        ...
        let pose_readability_metrics = format!(
            ...
            json_number(self.max_dive_pose_head_gaze_down_alignment),
