...
3. Move more glTF animation-player linking behind `SceneInstanceReady` helpers with clip-name validation and readiness metrics. Keep the existing named-clip contract and avoid hard-coded animation indices.
