...
pub(super) const MIN_UPDRAFT_RIBBON_VISUAL_COUNT: usize = 8;
pub(super) const MIN_CROSSWIND_GUIDE_VISUAL_COUNT: usize = 96;
...
pub(super) const MIN_UPDRAFT_FLOW_COHERENT_VISUAL_COUNT: usize = 96;
pub(super) const MIN_CROSSWIND_FLOW_COHERENT_VISUAL_COUNT: usize = 80;
