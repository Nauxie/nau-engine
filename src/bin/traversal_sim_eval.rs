...
const AIR_CONTROL_MIN_LATERAL_RESPONSE_MPS: f32 = 22.0;
...
const AIR_CONTROL_MAX_LATERAL_BODY_TRAVEL_HEADING_ERROR_DEGREES: f32 = 20.0;
...
const AIR_CONTROL_MAX_DESIRED_TRAVEL_HEADING_ERROR_DEGREES: f32 = 32.0;
