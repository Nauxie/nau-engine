...
impl EvalSample {
    pub fn to_json(&self) -> String {
        let json = format!(
            ...
            json_number(self.pose_grounded_stride_foot_travel_m),
            json_number(self.pose_grounded_stride_leg_opposition_degrees),
            json_number(self.pose_landing_crouch_m),
            json_number(self.pose_landing_foot_forward_m),
            json_number(self.pose_landing_foot_split_m),
            json_number(self.pose_landing_distal_foot_split_m),
            json_number(self.pose_landing_recovery_flip_degrees),
            json_number(self.pose_torso_backward_bend_degrees),
            json_number(self.pose_torso_local_bend_degrees),
            json_number(self.pose_torso_offset_m),
            json_number(self.pose_wing_airflow_strength),
            json_number(self.pose_scarf_stream_m),
            json_number(self.pose_scarf_lateral_sway_m),
            json_number(self.pose_scarf_tail_flex_degrees),
            ...
            json_array3(self.camera_position),
            json_array3(self.camera_look_target),
            json_number(self.camera_distance_m),
            json_number(self.camera_desired_boom_length_m),
            json_number(self.camera_resolved_boom_length_m),
            json_number(self.camera_boom_error_m),
            ...
            self.camera_obstruction_active_hits,
            self.camera_target_valid,
            self.camera_transform_valid,
            self.player_control_valid,
            self.invalid_transform_count,
            self.camera_obstruction_memory_active,
            self.camera_obstruction_memory_age_frames,
            self.camera_obstruction_stale_memory_age_frames,
            ...
            json_number(self.nearest_island_edge_distance_m),
            json_number(self.signed_island_edge_distance_m),
            self.near_island_edge,
            self.outside_island_footprint,
            ...
            self.generated_ruin_cluster_count,
            ...
            json_string(self.authored_transition_from_clip_label),
            json_string(self.authored_transition_to_clip_label),
            self.authored_transition_active,
            self.authored_transition_elapsed_ms,
            json_number(self.authored_transition_progress),
            json_string(self.authored_transition_class_label),
        ...
        let wind_force_metrics = format!(
            ...
            json_array3(self.crosswind_force_delta),
        ...
        let wind_visual_metrics = format!(
            "\"updraft_guide_visual_count\":{},\"updraft_ribbon_visual_count\":{},\"crosswind_guide_visual_count\":{},\"crosswind_ribbon_visual_count\":{},\"updraft_field_count\":{},\"updraft_fields_with_guides_count\":{},\"updraft_fields_with_ribbons_count\":{},\"updraft_fields_with_guides_and_ribbons_count\":{},\"updraft_flow_coherent_field_count\":{},\"crosswind_field_count\":{},\"crosswind_fields_with_guides_count\":{},\"crosswind_fields_with_ribbons_count\":{},\"crosswind_fields_with_guides_and_ribbons_count\":{},\"crosswind_flow_coherent_field_count\":{},\"max_updraft_visual_motion_m\":{},\"max_updraft_visual_rise_m\":{},\"max_updraft_visual_swirl_displacement_m\":{},\"max_updraft_visual_depth_span_m\":{},\"max_updraft_visual_scale_pulse\":{},\"max_crosswind_visual_motion_m\":{},\"max_crosswind_guide_flow_displacement_m\":{},\"max_crosswind_ribbon_flow_displacement_m\":{},\"max_crosswind_visual_lane_depth_span_m\":{},\"max_crosswind_visual_scale_pulse\":{},\"updraft_flow_coherent_visual_count\":{},\"crosswind_flow_coherent_visual_count\":{},\"crosswind_ribbon_flow_coherent_sample_count\":{},\"max_updraft_visual_flow_alignment\":{},\"max_crosswind_visual_flow_alignment\":{},\"max_crosswind_ribbon_visual_flow_alignment\":{},\"observed_updraft_flow_coherent_visual_count\":{},\"observed_crosswind_flow_coherent_visual_count\":{},\"observed_crosswind_ribbon_flow_coherent_sample_count\":{},\"max_observed_updraft_visual_frame_motion_m\":{},\"max_observed_updraft_visual_frame_rise_m\":{},\"max_observed_updraft_visual_frame_swirl_displacement_m\":{},\"max_observed_crosswind_visual_frame_motion_m\":{},\"max_observed_crosswind_guide_frame_flow_displacement_m\":{},\"max_observed_crosswind_ribbon_frame_flow_displacement_m\":{},\"max_observed_updraft_visual_speed_mps\":{},\"max_observed_crosswind_visual_speed_mps\":{},\"max_observed_wind_visual_acceleration_mps2\":{},\"observed_wind_visual_jump_count\":{},\"max_observed_updraft_visual_flow_alignment\":{},\"max_observed_crosswind_visual_flow_alignment\":{},\"max_observed_crosswind_ribbon_visual_flow_alignment\":{},{}",
            ...
            self.updraft_field_count,
            self.updraft_fields_with_guides_count,
            self.updraft_fields_with_ribbons_count,
            self.updraft_fields_with_guides_and_ribbons_count,
            self.updraft_flow_coherent_field_count,
            self.crosswind_field_count,
            self.crosswind_fields_with_guides_count,
            self.crosswind_fields_with_ribbons_count,
            self.crosswind_fields_with_guides_and_ribbons_count,
            self.crosswind_flow_coherent_field_count,
            ...
            self.observed_updraft_flow_coherent_visual_count,
    ...
    pub fn to_camera_player_trace_json(&self) -> String {
        format!(
            "{{\"frame\":{},\"time_secs\":{},\"player_position\":{},\"player_velocity\":{},\"mode\":{},\"movement_input_lateral_axis\":{},\"movement_input_forward_axis\":{},\"lateral_input_active\":{},\"camera_position\":{},\"camera_look_target\":{},\"camera_distance_m\":{},\"camera_desired_boom_length_m\":{},\"camera_resolved_boom_length_m\":{},\"camera_boom_error_m\":{},\"camera_step_distance_m\":{},\"camera_rotation_delta_degrees\":{},\"camera_player_angle_degrees\":{},\"camera_follow_direction_error_degrees\":{},\"camera_target_valid\":{},\"camera_transform_valid\":{},\"player_control_valid\":{},\"invalid_transform_count\":{},\"active_island_count\":{},\"near_lod_islands\":{},\"mid_lod_islands\":{},\"far_lod_islands\":{},\"world_collision_proxy_count\":{},\"world_collision_resolved_count\":{},\"terrain_rim_collision_resolved_count\":{},\"terrain_body_collision_resolved_count\":{},\"max_world_collision_push_m\":{},\"max_terrain_rim_collision_push_m\":{},\"max_terrain_body_collision_push_m\":{}}}",
            self.frame,
            json_number(self.time_secs),
            json_array3(self.position),
            json_array3(self.velocity),
    ...
    pub fn to_obstruction_decision_trace_json(&self) -> String {
        format!(
            "{{\"frame\":{},\"time_secs\":{},\"camera_position\":{},\"camera_look_target\":{},\"camera_distance_m\":{},\"camera_desired_boom_length_m\":{},\"camera_resolved_boom_length_m\":{},\"camera_boom_error_m\":{},\"camera_surface_clearance_m\":{},\"camera_step_distance_m\":{},\"camera_rotation_delta_degrees\":{},\"camera_obstruction_hits\":{},\"camera_obstruction_active_hits\":{},\"camera_obstruction_adjustment_m\":{},\"camera_obstruction_memory_active\":{},\"camera_obstruction_memory_age_frames\":{},\"camera_obstruction_stale_memory_age_frames\":{},\"camera_obstruction_snap_candidate\":{},\"camera_target_valid\":{},\"camera_transform_valid\":{},\"player_control_valid\":{},\"invalid_transform_count\":{},\"world_collision_resolved_count\":{},\"terrain_rim_collision_resolved_count\":{},\"terrain_body_collision_resolved_count\":{},\"max_world_collision_push_m\":{},\"max_terrain_rim_collision_push_m\":{},\"max_terrain_body_collision_push_m\":{}}}",
            self.frame,
            json_number(self.time_secs),
            json_array3(self.camera_position),
            json_array3(self.camera_look_target),
            ...
            self.camera_obstruction_memory_age_frames,
            self.camera_obstruction_stale_memory_age_frames,
            self.camera_obstruction_hits > 0 && self.camera_step_distance_m > 1.0,
            self.camera_target_valid,
            self.camera_transform_valid,
            self.player_control_valid,
            self.invalid_transform_count,
