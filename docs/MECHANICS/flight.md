...
- should read as a streamlined drop with torso/head alignment, narrow limb profile, trailing legs, and deployed glider wings pitching/sweeping under dive pressure when the glider is out; head gaze should track sink/travel pressure without locking straight down
