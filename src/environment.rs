...
pub const AERIAL_POWER_UP_ROUTE: [AerialPowerUp; 12] = [
    AerialPowerUp {
    ...
    AerialPowerUp {
        name: "stratos shelf gate",
        center: Vec3::new(-22.0, 210.0, -1138.0),
        radius_m: 26.0,
        forward_direction: Vec3::new(0.01, 0.0, -1.0),
        forward_speed_boost: 6.0,
        upward_speed_boost: 4.5,
        max_upward_speed: 25.0,
        effect_duration_secs: 0.75,
    ...
    AerialPowerUp {
        name: "summit anvil gate",
        center: Vec3::new(-18.0, 270.0, -1510.0),
        radius_m: 26.0,
        forward_direction: Vec3::new(-0.67, 0.0, -0.74),
        forward_speed_boost: 6.0,
        upward_speed_boost: 5.0,
        max_upward_speed: 26.0,
        effect_duration_secs: 0.75,
    ...
    AerialPowerUp {
        name: "upper sky shelf gate",
        center: Vec3::new(-210.0, 340.0, -1720.0),
        radius_m: 26.0,
        forward_direction: Vec3::new(0.85, 0.0, -0.53),
        forward_speed_boost: 6.5,
        upward_speed_boost: 5.0,
        max_upward_speed: 26.0,
        effect_duration_secs: 0.75,
    ...
    AerialPowerUp {
        name: "bluevault basin gate",
        center: Vec3::new(90.0, 422.0, -1905.0),
        radius_m: 26.0,
        forward_direction: Vec3::new(0.70, 0.0, -0.71),
        forward_speed_boost: 6.5,
        upward_speed_boost: 5.0,
        max_upward_speed: 27.0,
        effect_duration_secs: 0.75,
    ...
    AerialPowerUp {
        name: "sunspire garden gate",
        center: Vec3::new(420.0, 565.0, -2240.0),
        radius_m: 26.0,
        forward_direction: Vec3::new(-0.83, 0.0, -0.55),
        forward_speed_boost: 7.0,
        upward_speed_boost: 5.0,
        max_upward_speed: 27.0,
        effect_duration_secs: 0.75,
    ...
    AerialPowerUp {
        name: "great sky plateau gate",
        center: Vec3::new(-120.0, 755.0, -2600.0),
        radius_m: 28.0,
        forward_direction: Vec3::new(-0.37, 0.0, -0.93),
        forward_speed_boost: 7.0,
        upward_speed_boost: 5.0,
        max_upward_speed: 28.0,
        effect_duration_secs: 0.75,
    ...
    AerialPowerUp {
        name: "upper crown gate",
        center: Vec3::new(-360.0, 1080.0, -3200.0),
        radius_m: 24.0,
        forward_direction: Vec3::new(-0.37, 0.0, -0.93),
        forward_speed_boost: 7.5,
        upward_speed_boost: 5.0,
