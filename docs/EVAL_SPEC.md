...
- wind-force sample counts, sustained meaningful and flow-aligned wind-force sample counts, max active wind-force field count, crosswind and updraft-swirl force field counts, wind-force delta, crosswind delta, updraft-swirl delta, wind-force flow speed, wind-force variation, force-flow alignment, and flow-aligned delta
...
- pose torso pitch, arm spread, leg tuck, lateral lean, signed right/left lateral lean, landing crouch, landing foot-forward tuck, landing flare, wing-airflow maxima, authored glider response/motion maxima, key-pose readability min/max, unreadable key-pose sample count, and key-pose transition-grace sample count
