...
16. The camera avoids tagged obstruction volumes, including route-integrated generated spires shared with the simulation harness, and is lifted above the active collision terrain surface when needed.
...
22. The default world is a 20-island archipelago with 19 route terrain archetypes, varied procedural terrain materials, bounded generated terrain incisions/shelves/microrelief, procedural island bodies, far-LOD layered island impostors, collidable route landmarks/trees/rocks/obstruction spires, 16 sampled terrain-rim collision segments per near-LOD island, near/far gameplay updrafts, batched near-LOD ground cover, and a three-gate aerial boost route.
