...
- `pose_state_coverage`: current full-pose chain coverage for walk/run stride, launch/fall/glide, right and left air-turn, air-brake/gliding-dive, landing anticipation/recovery shape, authored-jog/authored-fall, and zero-unreadable pose-state coverage.
