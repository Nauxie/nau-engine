...
use crate::{
    animation::{
        LANDING_MAX_ANTICIPATION_BACKBEND_DEGREES, LANDING_MAX_RECOVERY_BACKBEND_DEGREES,
        LANDING_MAX_TORSO_BACKWARD_BEND_DEGREES, LANDING_MAX_TORSO_LOCAL_BEND_DEGREES,
        LANDING_MAX_TORSO_LOCAL_OFFSET_M, LANDING_MIN_FOOT_FORWARD_READABILITY_M,
        LANDING_MIN_FOOT_SPLIT_READABILITY_M, LANDING_MIN_TORSO_FORWARD_FOLD_DEGREES,
    },
    world::{
...
pub(super) const MAX_RESIDENT_ISLAND_VISUAL_COUNT: usize = 280;
pub(super) const MIN_SKY_ISLAND_COUNT: usize = SKY_ROUTE_ISLAND_COUNT;
pub(super) const MIN_GENERATED_GROUND_COVER_PATCH_COUNT: usize = 2_400;
pub(super) const MIN_GROUND_COVER_BLADE_COUNT: usize = 120;
pub(super) const MIN_GROUND_COVER_MESH_VERTICES: usize = 720;
pub(super) const MIN_GENERATED_TREE_TRUNK_COUNT: usize = 160;
pub(super) const MIN_GENERATED_TREE_CANOPY_COUNT: usize = 160;
pub(super) const MIN_TREE_TRUNK_MESH_VERTICES: usize = 190;
pub(super) const MIN_TREE_CANOPY_MESH_VERTICES: usize = 450;
pub(super) const MIN_DETAIL_BIOME_PALETTE_COUNT: usize = 5;
pub(super) const MIN_GENERATED_ROCK_COUNT: usize = 230;
pub(super) const MIN_ROCK_MESH_VERTICES: usize = 70;
pub(super) const MIN_GENERATED_LANDMARK_COUNT: usize = 40;
pub(super) const MIN_GENERATED_RUIN_CLUSTER_COUNT: usize = 6;
...
pub(super) const MIN_GENERATED_POND_SURFACE_COUNT: usize = 5;
pub(super) const MIN_LANDMARK_MESH_VERTICES: usize = 39;
pub(super) const MIN_GENERATED_WEATHER_CLOUD_COUNT: usize = 40;
pub(super) const MIN_GENERATED_WEATHER_CLOUD_BANK_COUNT: usize = SKY_ROUTE_ISLAND_COUNT;
...
pub(super) const MIN_WEATHER_CLOUD_MESH_VERTICES: usize = 1530;
pub(super) const MIN_WEATHER_CLOUD_FILAMENT_RIBBON_DETAIL_COUNT: usize = 27;
pub(super) const MIN_ISLAND_TERRAIN_SURFACE_COUNT: usize = SKY_ROUTE_ISLAND_COUNT;
...
pub(super) const AIR_CONTROL_RESPONSE_THRESHOLD_MPS: f32 = 6.0;
pub(super) const AIR_CONTROL_MAX_LATERAL_RESPONSE_LATENCY_SECS: f32 = 0.20;
pub(super) const AIR_CONTROL_MIN_LATERAL_RESPONSE_MPS: f32 = 26.0;
...
pub(super) const AIR_CONTROL_MAX_AVG_BODY_HEADING_ERROR_DEGREES: f32 = 5.0;
pub(super) const AIR_CONTROL_MAX_P95_BODY_HEADING_ERROR_DEGREES: f32 = 15.0;
pub(super) const AIR_CONTROL_MAX_BODY_HEADING_ERROR_DEGREES: f32 = 24.0;
pub(super) const AIR_CONTROL_MAX_P95_LATERAL_BODY_TRAVEL_HEADING_ERROR_DEGREES: f32 = 8.0;
pub(super) const AIR_CONTROL_MAX_LATERAL_BODY_TRAVEL_HEADING_ERROR_DEGREES: f32 = 18.0;
pub(super) const AIR_CONTROL_MAX_P95_BACKWARD_DIAGONAL_BODY_TRAVEL_HEADING_ERROR_DEGREES: f32 = 8.0;
pub(super) const AIR_CONTROL_MAX_BACKWARD_DIAGONAL_BODY_TRAVEL_HEADING_ERROR_DEGREES: f32 = 12.0;
pub(super) const AIR_CONTROL_MIN_LATERAL_BODY_TRAVEL_HEADING_SAMPLES: u32 = 4;
pub(super) const AIR_CONTROL_MIN_PURE_AIR_TURN_SIDEWAYS_SAMPLES: u32 = 4;
pub(super) const AIR_CONTROL_PURE_AIR_TURN_SIDEWAYS_SETTLE_SECS: f32 = 0.10;
pub(super) const AIR_CONTROL_MIN_BACKWARD_DIAGONAL_BODY_TRAVEL_HEADING_SAMPLES: u32 = 4;
pub(super) const AIR_CONTROL_MIN_DESIRED_TRAVEL_HEADING_SAMPLES: u32 = 8;
pub(super) const AIR_CONTROL_MIN_DIRECTIONAL_DESIRED_TRAVEL_HEADING_SAMPLES: u32 = 4;
pub(super) const AIR_CONTROL_MAX_P95_DESIRED_TRAVEL_HEADING_ERROR_DEGREES: f32 = 8.0;
pub(super) const AIR_CONTROL_MAX_DESIRED_TRAVEL_HEADING_ERROR_DEGREES: f32 = 26.0;
pub(super) const AIR_CONTROL_MAX_BODY_YAW_ERROR_STEP_DEGREES: f32 = 28.0;
pub(super) const AIR_CONTROL_MAX_BODY_YAW_OSCILLATIONS: f32 = 0.0;
...
pub(super) const AIR_CONTROL_MAX_AVG_CAMERA_FOLLOW_ERROR_DEGREES: f32 = 10.0;
pub(super) const AIR_CONTROL_MAX_P95_CAMERA_FOLLOW_ERROR_DEGREES: f32 = 20.0;
pub(super) const CAMERA_MOUSE_MIN_MOVEMENT_CAMERA_HEADING_SAMPLES: u32 = 30;
pub(super) const CAMERA_MOUSE_MAX_MOVEMENT_CAMERA_HEADING_ERROR_DEGREES: f32 = 0.05;
pub(super) const CAMERA_MOUSE_MAX_CAMERA_PLAYER_RELATIVE_STEP_M: f32 = 0.38;
...
pub(super) const AIR_CONTROL_MIN_AIR_BRAKE_SPEED_DROP_MPS: f32 = 13.0;
pub(super) const AIR_CONTROL_MIN_AIR_BRAKE_PLANAR_SPEED_DROP_MPS: f32 = 11.5;
...
pub(super) const AIR_CONTROL_MIN_DIRECTIONAL_POSE_AIR_TURN_SAMPLES: u32 = 4;
pub(super) const AIR_CONTROL_MIN_POSE_AIR_BRAKE_SAMPLES: u32 = 4;
pub(super) const AIR_CONTROL_MIN_DIRECTIONAL_POSE_AIR_BRAKE_SAMPLES: u32 = 4;
...
pub(super) const AIR_CONTROL_MIN_DIVE_POSE_TORSO_PITCH_DEGREES: f32 = 60.0;
pub(super) const AIR_CONTROL_MAX_DIVE_POSE_ARM_SPREAD_DEGREES: f32 = 100.0;
pub(super) const AIR_CONTROL_MIN_DIVE_POSE_LEG_TUCK_DEGREES: f32 = 55.0;
...
pub(super) const MIN_VISIBLE_POSE_PART_COUNT: u32 = 15;
pub(super) const MIN_POSE_LIMB_CLEARANCE_M: f32 = 0.04;
pub(super) const MAX_POSE_LIMB_PENETRATION_M: f32 = 0.0;
pub(super) const MAX_POSE_JOINT_GAP_M: f32 = 0.02;
pub(super) const MIN_POSE_JOINT_GAP_SAMPLES: u32 = 1;
pub(super) const MIN_POSE_SCARF_STREAM_M: f32 = 0.25;
pub(super) const MIN_POSE_SCARF_LATERAL_SWAY_M: f32 = 0.03;
...
pub(super) const LANDING_MAX_POSE_PART_ROTATION_DELTA_DEGREES: f32 = 60.0;
pub(super) const LANDING_MAX_POSE_PART_TRANSLATION_DELTA_M: f32 = 0.25;
...
pub const LANDING_MIN_POSE_FOOT_SPLIT_M: f32 = LANDING_MIN_FOOT_SPLIT_READABILITY_M;
pub const LANDING_MIN_POSE_FLARE_DEGREES: f32 = 34.0;
pub const LANDING_MAX_POSE_ANTICIPATION_BACKBEND_DEGREES: f32 =
    LANDING_MAX_ANTICIPATION_BACKBEND_DEGREES;
pub const LANDING_MAX_POSE_RECOVERY_BACKBEND_DEGREES: f32 = LANDING_MAX_RECOVERY_BACKBEND_DEGREES;
pub const LANDING_MIN_POSE_FORWARD_FOLD_DEGREES: f32 = LANDING_MIN_TORSO_FORWARD_FOLD_DEGREES;
pub const LANDING_MAX_POSE_BACKWARD_BEND_DEGREES: f32 = LANDING_MAX_TORSO_BACKWARD_BEND_DEGREES;
pub const LANDING_MAX_POSE_TRANSITION_BACKBEND_DEGREES: f32 = LANDING_MAX_TORSO_LOCAL_BEND_DEGREES;
pub const LANDING_MAX_POSE_TORSO_OFFSET_M: f32 = LANDING_MAX_TORSO_LOCAL_OFFSET_M;
pub const POSE_STATE_MIN_DIRECTIONAL_AIR_TURN_SAMPLES: f32 = 5.0;
...
pub const MIN_DYNAMIC_WIND_FLOW_DIRECTION_CHANGE_DEGREES: f32 = 4.0;
...
pub const UNDER_ROUTE_MIN_UPDRAFT_SWIRL_FORCE_DELTA_MPS: f32 = 0.027;
pub const MIN_WIND_FORCE_FLOW_SPEED_MPS: f32 = 6.0;
pub const MIN_WIND_FORCE_VARIATION: f32 = 0.12;
pub const MIN_WIND_FORCE_FLOW_ALIGNMENT: f32 = 0.72;
pub const MIN_WIND_FORCE_ALIGNED_DELTA_MPS: f32 = 0.03;
pub const MIN_WIND_FORCE_SAMPLE_COUNT: u32 = 2;
pub const MIN_CROSSWIND_FORCE_SAMPLE_COUNT: u32 = 2;
pub const MIN_WIND_LOAD_RESPONSE_SAMPLE_COUNT: u32 = 4;
pub const MIN_WIND_LOAD_LATERAL_LOAD: f32 = 0.35;
pub const MIN_WIND_LOAD_POSE_LEAN_DEGREES: f32 = 4.0;
pub const MIN_WIND_LOAD_GLIDER_RESPONSE_DEGREES: f32 = 2.0;
pub const MIN_PLAYER_WIND_SHEAR_VISUAL_COUNT: usize = 18;
pub const MIN_VISIBLE_PLAYER_WIND_SHEAR_VISUAL_COUNT: usize = 8;
pub const MAX_VISIBLE_PLAYER_WIND_SHEAR_VISUAL_COUNT: usize = 16;
pub const MIN_PLAYER_WIND_SHEAR_LENGTH_SCALE: f32 = 0.85;
pub const MIN_PLAYER_WIND_SHEAR_LATERAL_OFFSET_M: f32 = 1.05;
pub const MIN_PLAYER_WIND_SHEAR_DEPTH_OFFSET_M: f32 = 1.45;
pub const MIN_PLAYER_WIND_SHEAR_ANGULAR_COVERAGE_DEGREES: f32 = 300.0;
pub const MIN_PLAYER_WIND_SHEAR_VERTICAL_COVERAGE_M: f32 = 1.30;
pub const MIN_PLAYER_WIND_SHEAR_FRAME_MOTION_M: f32 = 0.035;
pub const MAX_PLAYER_WIND_SHEAR_FRAME_MOTION_M: f32 = 0.42;
pub const MIN_PLAYER_WIND_SHEAR_ORBIT_RADIUS_M: f32 = 1.05;
pub const MIN_PLAYER_WIND_SHEAR_PULSE_SCALE: f32 = 1.02;
pub const MAX_PLAYER_WIND_SHEAR_PULSE_SCALE: f32 = 1.16;
pub const MIN_PLAYER_WIND_SHEAR_DIVE_PRESSURE: f32 = 0.12;
pub const MIN_PLAYER_WIND_SHEAR_RELATIVE_AIR_SPEED_MPS: f32 = 12.0;
pub const MIN_PLAYER_WIND_SHEAR_FLOW_ALIGNMENT: f32 = 0.70;
pub const MIN_PLAYER_WIND_SHEAR_FLOW_TRAVEL_M: f32 = 0.025;
pub const MIN_PLAYER_WIND_SHEAR_CROSSWIND_DEFLECTION_M: f32 = 0.35;
pub const MIN_PLAYER_WIND_SHEAR_BODY_CLEARANCE_M: f32 = 1.15;
pub const MIN_PLAYER_WIND_SHEAR_FIELD_SPAN_M: f32 = 4.20;
pub const MAX_LOW_SPEED_PLAYER_WIND_SHEAR_VISIBLE_SAMPLES: u32 = 0;
pub const MIN_VISIBLE_PLAYER_WIND_SHEAR_KIND_COUNT: usize = 6;
pub const MIN_CROSSWIND_NEUTRAL_DRIFT_SAMPLE_COUNT: u32 = 3;
pub const MIN_CROSSWIND_NEUTRAL_HORIZONTAL_DRIFT_M: f32 = 0.20;
pub const MAX_CROSSWIND_NEUTRAL_HORIZONTAL_STEP_M: f32 = 3.0;

pub fn min_updraft_swirl_force_delta_mps_for_scenario(scenario_name: &str) -> f32 {
    if scenario_name == super::scenarios::UNDERBRIDGE_UNDER_ROUTE {
        UNDER_ROUTE_MIN_UPDRAFT_SWIRL_FORCE_DELTA_MPS
    } else {
        MIN_UPDRAFT_SWIRL_FORCE_DELTA_MPS
    }
}
pub const MIN_DYNAMIC_LIFT_APPLIED_DELTA_MPS: f32 = 0.45;
pub const MIN_DYNAMIC_LIFT_MULTIPLIER_RANGE: f32 = 0.10;
pub(super) const MIN_UPDRAFT_GUIDE_VISUAL_COUNT: usize = 126;
pub(super) const MIN_UPDRAFT_RIBBON_VISUAL_COUNT: usize = 12;
pub(super) const MIN_CROSSWIND_GUIDE_VISUAL_COUNT: usize = 180;
pub(super) const MIN_CROSSWIND_RIBBON_VISUAL_COUNT: usize = 21;
pub(super) const MIN_UPDRAFT_VISUAL_MOTION_M: f32 = 30.0;
pub(super) const MIN_UPDRAFT_VISUAL_RISE_M: f32 = 18.0;
pub(super) const MIN_UPDRAFT_VISUAL_SWIRL_DISPLACEMENT_M: f32 = 6.0;
pub(super) const MIN_UPDRAFT_VISUAL_DEPTH_SPAN_M: f32 = 80.0;
pub(super) const MIN_UPDRAFT_VISUAL_SCALE_PULSE: f32 = 0.22;
pub(super) const MIN_CROSSWIND_VISUAL_MOTION_M: f32 = 30.0;
pub(super) const MIN_CROSSWIND_GUIDE_FLOW_DISPLACEMENT_M: f32 = 18.0;
pub(super) const MIN_CROSSWIND_RIBBON_FLOW_DISPLACEMENT_M: f32 = 8.0;
pub(super) const MIN_CROSSWIND_VISUAL_LANE_DEPTH_SPAN_M: f32 = 45.0;
pub(super) const MIN_CROSSWIND_VISUAL_SCALE_PULSE: f32 = 0.24;
pub(super) const MIN_UPDRAFT_FLOW_COHERENT_VISUAL_COUNT: usize = 126;
pub(super) const MIN_CROSSWIND_FLOW_COHERENT_VISUAL_COUNT: usize = 180;
pub(super) const MIN_CROSSWIND_RIBBON_FLOW_COHERENT_SAMPLE_COUNT: usize = 30;
pub(super) const MIN_WIND_VISUAL_FLOW_ALIGNMENT: f32 = 0.55;
pub(super) const MIN_OBSERVED_UPDRAFT_VISUAL_FRAME_MOTION_M: f32 = 0.02;
pub(super) const MIN_OBSERVED_UPDRAFT_VISUAL_FRAME_RISE_M: f32 = 0.005;
pub(super) const MIN_OBSERVED_UPDRAFT_VISUAL_FRAME_SWIRL_DISPLACEMENT_M: f32 = 0.003;
pub(super) const MIN_OBSERVED_CROSSWIND_VISUAL_FRAME_MOTION_M: f32 = 0.02;
pub(super) const MIN_OBSERVED_CROSSWIND_GUIDE_FRAME_FLOW_DISPLACEMENT_M: f32 = 0.01;
pub(super) const MIN_OBSERVED_CROSSWIND_RIBBON_FRAME_FLOW_DISPLACEMENT_M: f32 = 0.01;
pub(super) const MAX_OBSERVED_UPDRAFT_VISUAL_SPEED_MPS: f32 = 35.0;
pub(super) const MAX_OBSERVED_CROSSWIND_VISUAL_SPEED_MPS: f32 = 25.0;
pub(super) const MAX_OBSERVED_WIND_VISUAL_ACCELERATION_MPS2: f32 = 650.0;
pub(super) const MAX_OBSERVED_WIND_VISUAL_JUMP_COUNT: u32 = 0;
pub(super) const SUSTAINED_WIND_VISUAL_FLOW_FLOOR_RATIO: f32 = 0.75;
pub(super) const MIN_SUSTAINED_WIND_VISUAL_FLOW_SAMPLES: u32 = 32;
...
pub(super) const MIN_SUSTAINED_CROSSWIND_RIBBON_ADVECTED_FLOW_SAMPLES: u32 = 28;
...
pub(super) const MIN_TERRAIN_BODY_COLLISION_PROXY_COUNT: usize = 2;
...
pub(super) const MIN_LANDMARK_WORLD_COLLISION_PROXY_COUNT: usize = 40;
...
pub(super) const MAX_WORLD_COLLISION_CONTACT_PUSH_M: f32 = 0.10;
pub(super) const MIN_TERRAIN_RIM_COLLISION_CONTACT_SAMPLES: u32 = 8;
pub(super) const MAX_TERRAIN_RIM_COLLISION_CONTACT_PUSH_M: f32 = 0.15;
...
pub(super) const MAX_TERRAIN_BODY_COLLISION_CONTACT_PUSH_M: f32 = 0.15;
...
pub struct EvalThresholds {
    ...
    pub max_camera_obstruction_snap_count: u32,
...
impl EvalThresholds {
    pub(super) fn to_json(self, indent: &str) -> String {
        format!(
            ...
            self.max_camera_obstruction_snap_count,
