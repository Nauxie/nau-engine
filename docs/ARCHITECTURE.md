...
- `src/eval_app_runtime/metrics.rs` owns app eval frame-time, per-sample metric collection, visible generated-pose transform measurement, and authored player clip-alignment scoring for key-pose readability.
