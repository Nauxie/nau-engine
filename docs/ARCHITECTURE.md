...
- `src/eval/accumulator/movement.rs` owns movement, body-heading, body-roll, lateral-response, air-brake, pose-readability, and mode-count accumulation.
