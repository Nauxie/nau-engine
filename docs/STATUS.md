...
- `air_control_response` eval proves diagonal/lateral airborne steering, separate right/left response latency, backward braking, post-brake recovery, heading alignment, yaw oscillation count, zero movement-driven camera orbit offset, and bounded camera rotation delta.
