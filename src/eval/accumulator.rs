...
pub struct EvalAccumulator {
    ...
    max_camera_distance_frame: u32,
    min_camera_surface_clearance_m: f32,
    max_camera_player_angle_degrees: f32,
    max_camera_step_distance_m: f32,
    max_camera_step_distance_frame: u32,
    max_camera_step_during_stream_change_m: f32,
    max_camera_step_during_stream_change_frame: u32,
    max_camera_rotation_during_stream_change_degrees: f32,
    max_camera_rotation_during_stream_change_frame: u32,
    max_camera_rotation_delta_degrees: f32,
    max_camera_rotation_delta_frame: u32,
    ...
    invalid_camera_target_samples: u32,
    invalid_camera_transform_samples: u32,
    invalid_player_control_samples: u32,
    invalid_transform_samples: u32,
    max_camera_obstruction_memory_age_frames: u32,
    max_camera_obstruction_stale_memory_age_frames: u32,
    max_camera_obstruction_stale_memory_age_frame: u32,
    max_camera_boom_error_m: f32,
    max_camera_boom_error_frame: u32,
    ...
    max_lateral_input_unresponsive_duration_secs: f32,
    current_lateral_input_unresponsive_start_secs: Option<f32>,
