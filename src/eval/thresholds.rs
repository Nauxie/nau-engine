...
pub(super) const AIR_CONTROL_MAX_P95_LATERAL_BODY_TRAVEL_HEADING_ERROR_DEGREES: f32 = 24.0;
pub(super) const AIR_CONTROL_MAX_LATERAL_BODY_TRAVEL_HEADING_ERROR_DEGREES: f32 = 40.0;
pub(super) const AIR_CONTROL_MAX_P95_BACKWARD_DIAGONAL_BODY_TRAVEL_HEADING_ERROR_DEGREES: f32 =
    18.0;
pub(super) const AIR_CONTROL_MAX_BACKWARD_DIAGONAL_BODY_TRAVEL_HEADING_ERROR_DEGREES: f32 = 24.0;
...
pub(super) const AIR_CONTROL_MAX_P95_DESIRED_TRAVEL_HEADING_ERROR_DEGREES: f32 = 24.0;
pub(super) const AIR_CONTROL_MAX_DESIRED_TRAVEL_HEADING_ERROR_DEGREES: f32 = 45.0;
