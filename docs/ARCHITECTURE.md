...
- `src/bin/visual_audit/report.rs` owns sequence-level visual-audit checks, including route-marker identity, distant-impostor span, foliage tile spread, cloud-layer span, and JSON report serialization.
