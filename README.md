...
Collision evals gate aggregate proxy counts, 16-segment terrain-rim contours, and solid non-rim proxy distribution across trees, rocks, and landmarks so decorative island detail cannot silently lose physical blockers while terrain-rim proxies keep the aggregate count green.
