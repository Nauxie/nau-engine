...
use nau_engine::{
    animation::{
        ...
        player_wind_shear_response, player_wind_shear_visual_estimate, pose_readability_metrics,
...
pub(crate) struct SimSample {
    ...
    pub(crate) player_wind_shear_visual_count: usize,
    pub(crate) visible_player_wind_shear_visual_count: usize,
    pub(crate) max_player_wind_shear_airflow: f32,
    pub(crate) max_player_wind_shear_dive_pressure: f32,
    pub(crate) max_player_wind_shear_acceleration_pressure: f32,
    pub(crate) max_player_wind_shear_lateral_shear: f32,
    pub(crate) max_player_wind_shear_length_scale: f32,
    pub(crate) max_player_wind_shear_lateral_offset_m: f32,
    pub(crate) max_player_wind_shear_depth_offset_m: f32,
    pub(crate) max_player_wind_shear_angular_coverage_degrees: f32,
    pub(crate) max_player_wind_shear_vertical_coverage_m: f32,
    pub(crate) max_player_wind_shear_frame_motion_m: f32,
    pub(crate) max_player_wind_shear_orbit_radius_m: f32,
    pub(crate) max_player_wind_shear_pulse_scale: f32,
    pub(crate) max_player_wind_shear_relative_air_speed_mps: f32,
    pub(crate) max_player_wind_shear_flow_alignment: f32,
    pub(crate) max_player_wind_shear_flow_travel_m: f32,
    pub(crate) max_player_wind_shear_crosswind_deflection_m: f32,
    pub(crate) min_player_wind_shear_body_clearance_m: f32,
    pub(crate) max_player_wind_shear_field_span_m: f32,
    pub(crate) visible_player_wind_shear_kind_count: usize,
...
impl SimSample {
    ...
    pub(crate) fn new(
        ...
        let wind_shear = player_wind_shear_visual_estimate(player_wind_shear_response(
            state.controller.mode,
            state.velocity,
            Some(previous_velocity),
            player_rotation,
            wind_force.applied_delta,
            wind_lateral_load,
            scenario.fixed_dt,
            time_secs,
        ));
        ...
        Self {
            ...
            pose_intent_label,
            dive_input_active: pose_input.dive,
            ...
            pose_head_gaze_down_alignment: pose_readability.head_gaze_down_alignment,
            ...
            player_wind_shear_visual_count: wind_shear.visual_count,
            visible_player_wind_shear_visual_count: wind_shear.visible_visual_count,
            max_player_wind_shear_airflow: wind_shear.max_airflow,
            max_player_wind_shear_dive_pressure: wind_shear.max_dive_pressure,
            max_player_wind_shear_acceleration_pressure: wind_shear.max_acceleration_pressure,
            max_player_wind_shear_lateral_shear: wind_shear.max_abs_lateral_shear,
            max_player_wind_shear_length_scale: wind_shear.max_length_scale,
            max_player_wind_shear_lateral_offset_m: wind_shear.max_lateral_offset_m,
            max_player_wind_shear_depth_offset_m: wind_shear.max_depth_offset_m,
            max_player_wind_shear_angular_coverage_degrees: wind_shear.max_angular_coverage_degrees,
            max_player_wind_shear_vertical_coverage_m: wind_shear.max_vertical_coverage_m,
            max_player_wind_shear_frame_motion_m: wind_shear.max_frame_motion_m,
            max_player_wind_shear_orbit_radius_m: wind_shear.max_orbit_radius_m,
            max_player_wind_shear_pulse_scale: wind_shear.max_pulse_scale,
            max_player_wind_shear_relative_air_speed_mps: wind_shear.max_relative_air_speed_mps,
            max_player_wind_shear_flow_alignment: wind_shear.max_flow_alignment,
            max_player_wind_shear_flow_travel_m: wind_shear.max_flow_travel_m,
            max_player_wind_shear_crosswind_deflection_m: wind_shear.max_crosswind_deflection_m,
            min_player_wind_shear_body_clearance_m: wind_shear.min_body_clearance_m,
            max_player_wind_shear_field_span_m: wind_shear.max_field_span_m,
            visible_player_wind_shear_kind_count: wind_shear.visible_kind_count,
    ...
    pub(crate) fn to_json(&self) -> Value {
        json!({
            ...
            "dive_input_active": self.dive_input_active,
            ...
            "pose_head_gaze_down_alignment": round4(self.pose_head_gaze_down_alignment),
            ...
            "player_wind_shear_visual_count": self.player_wind_shear_visual_count,
            "visible_player_wind_shear_visual_count": self.visible_player_wind_shear_visual_count,
            "max_player_wind_shear_airflow": round4(self.max_player_wind_shear_airflow),
            "max_player_wind_shear_dive_pressure": round4(self.max_player_wind_shear_dive_pressure),
            "max_player_wind_shear_acceleration_pressure": round4(self.max_player_wind_shear_acceleration_pressure),
            "max_player_wind_shear_lateral_shear": round4(self.max_player_wind_shear_lateral_shear),
            "max_player_wind_shear_length_scale": round4(self.max_player_wind_shear_length_scale),
            "max_player_wind_shear_lateral_offset_m": round4(self.max_player_wind_shear_lateral_offset_m),
            "max_player_wind_shear_depth_offset_m": round4(self.max_player_wind_shear_depth_offset_m),
            "max_player_wind_shear_angular_coverage_degrees": round4(self.max_player_wind_shear_angular_coverage_degrees),
            "max_player_wind_shear_vertical_coverage_m": round4(self.max_player_wind_shear_vertical_coverage_m),
            "max_player_wind_shear_frame_motion_m": round4(self.max_player_wind_shear_frame_motion_m),
            "max_player_wind_shear_orbit_radius_m": round4(self.max_player_wind_shear_orbit_radius_m),
            "max_player_wind_shear_pulse_scale": round4(self.max_player_wind_shear_pulse_scale),
            "max_player_wind_shear_relative_air_speed_mps": round4(self.max_player_wind_shear_relative_air_speed_mps),
            "max_player_wind_shear_flow_alignment": round4(self.max_player_wind_shear_flow_alignment),
            "max_player_wind_shear_flow_travel_m": round4(self.max_player_wind_shear_flow_travel_m),
            "max_player_wind_shear_crosswind_deflection_m": round4(self.max_player_wind_shear_crosswind_deflection_m),
            "min_player_wind_shear_body_clearance_m": round4(self.min_player_wind_shear_body_clearance_m),
            "max_player_wind_shear_field_span_m": round4(self.max_player_wind_shear_field_span_m),
            "visible_player_wind_shear_kind_count": self.visible_player_wind_shear_kind_count,
