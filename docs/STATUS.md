...
- Diagnostics, eval metrics, and richer pose math live in testable pure functions in `src/lib.rs`, with movement, environment, camera, and route-surface/world math split into dedicated modules.
