...
- enough wind guide/ribbon visuals must have short-horizon motion aligned with the shared `WindField::flow_at` vector; current floors require 126 coherent updraft visuals, 180 coherent crosswind visuals, and at least 0.55 max alignment for each family
