...
- repo-native asset fixture audit for every declared glTF fixture, checking provenance, semantic component names, strengthened mesh/material/vertex/triangle floors, normals, UVs, blend-material expectations, player named animation clip inventory, animated player joint gaps, joint-cover mesh gap/overlap contact bands, bridge-sleeve continuity, pose-by-pose limb/contact reports, belly-down freefall shape, and launch glider takeout motion
