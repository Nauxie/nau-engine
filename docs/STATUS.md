...
- Crosswind stream fields are still debug gizmos; updrafts, generated trees, clouds, and ponds now have cinematic primitive motion cues, and the visible glider has a multi-part authored glTF fixture, but there are no particles, cloth simulation, or authored environment art assets yet.
