...
- the island-visual catalog unit audit classifies every generated solid visual name by collision kind, requires 16 sampled terrain-rim contour segments per route island, and fails any camera obstacle without collision unless it is explicitly allowlisted as camera-only foliage or cliff-body obstruction
