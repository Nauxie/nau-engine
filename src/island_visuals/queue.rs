...
use super::types::{
    ...
    IslandVisualMaterial, IslandVisualMeshRecipe,
};
use crate::camera_runtime::CameraObstacle;
use crate::content_diagnostics::IslandContentDiagnostics;
use crate::generated_content::{
    ISLAND_BODY_SEGMENTS, IslandDetailMaterials, WaterSurfaceMaterials,
    island_body_mesh_diagnostics, island_impostor_cliff_mesh, island_impostor_mesh_diagnostics,
    island_impostor_terrain_mesh, island_impostor_underside_mesh, island_terrain_mesh_diagnostics,
...
fn queue_island_visual_with_motion(
    ...
    material: Option<IslandVisualMaterial>,
    transform: Transform,
    obstacle: Option<CameraObstacle>,
...
pub(crate) fn queue_sky_island(
    ...
    top_material: Handle<SurfaceMaterial>,
