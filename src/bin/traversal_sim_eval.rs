...
const AIR_CONTROL_MAX_P95_LATERAL_BODY_TRAVEL_HEADING_ERROR_DEGREES: f32 = 45.0;
const AIR_CONTROL_MAX_LATERAL_BODY_TRAVEL_HEADING_ERROR_DEGREES: f32 = 60.0;
const AIR_CONTROL_MAX_P95_BACKWARD_DIAGONAL_BODY_TRAVEL_HEADING_ERROR_DEGREES: f32 = 35.0;
const AIR_CONTROL_MAX_BACKWARD_DIAGONAL_BODY_TRAVEL_HEADING_ERROR_DEGREES: f32 = 50.0;
const AIR_CONTROL_MIN_LATERAL_BODY_TRAVEL_HEADING_SAMPLES: u32 = 1;
const AIR_CONTROL_MIN_BACKWARD_DIAGONAL_BODY_TRAVEL_HEADING_SAMPLES: u32 = 1;
...
const AIR_CONTROL_MIN_SIGNED_POSE_LATERAL_LEAN_DEGREES: f32 = 8.0;
