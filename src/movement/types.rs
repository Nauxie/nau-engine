...
impl Default for FlightTuning {
    fn default() -> Self {
        Self {
            ...
            glide_lateral_accel: 18.0,
            glide_brake_drag: 0.30,
            air_brake_accel: 46.0,
            glide_brake_accel: 72.0,
            ...
            air_counter_steer_accel: 135.0,
            glide_counter_steer_accel: 375.0,
            air_steer_min_speed: 16.0,
            air_velocity_turn_rate_degrees: 185.0,
            glide_velocity_turn_rate_degrees: 320.0,
            air_velocity_counter_turn_rate_degrees: 285.0,
            glide_velocity_counter_turn_rate_degrees: 500.0,
