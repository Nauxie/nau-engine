...
1. Replace the self-authored fixture scenes and remaining placeholder visual asset slots with real compatible glTF scenes, starting with character scale, the declared player animation clip set, terrain, foliage, water, and richer island impostor kits.
