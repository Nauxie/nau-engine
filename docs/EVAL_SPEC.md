...
- `player_pose_sheet.svg`: windowless player fixture pose sheet emitted by `tools/player_pose_preview.sh` for human review, including mesh-surface contact overlays where connector surfaces visibly separate.
- `player_transition_pose_sheet.svg`: windowless player fixture transition sheet emitted by `tools/player_pose_preview.sh`, showing high-risk 50% traversal blend frames with the same mesh-surface contact overlays.
