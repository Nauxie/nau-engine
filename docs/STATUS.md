...
2. Add terrain/material-specific screenshot shape checks beyond the current scene-family, foliage-spread, cloud-span, distant-impostor-span, and projection-hit gates.
