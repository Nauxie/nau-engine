...
- `./tools/terrain_export.sh target/terrain_export` writes a manifest, per-island OBJ meshes, terrain material-weight CSV sidecars, and `audit.json` without creating a native window.
