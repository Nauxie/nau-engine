...
pub use scenarios::{
    ...
    ISLAND_LAUNCH_TO_LANDING, LONG_GLIDE_VISIBILITY, POSE_STATE_COVERAGE, SCENARIO_NAMES,
    TERRAIN_BODY_COLLISION_CONTACT, TERRAIN_RIM_COLLISION_CONTACT, UNDERBRIDGE_UNDER_ROUTE,
    UPDRAFT_ROUTE, WORLD_COLLISION_CONTACT, scenario_named, scripted_camera_input, scripted_input,
};
